...
class KfoldCrossValidation:
    #-------------------------------------------------
    def __init__(self, foldnum, DataBase, trialaxis = 2, trial_match=False):
        ...
        if trial_match:
            ...
            # print(self.trialnum)
            # print(self.foldnum)
            rdr = self.trialnum % self.foldnum
        else:
            rdr = 0
        # print(rdr)
        self.idx = np.random.choice(self.trialnum, self.trialnum - rdr, replace=False)
